          ...
          <div className="relative">
            <div className="relative flex flex-col gap-4 lg:gap-0">
              ...
              <div className="relative grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-0">
                ...
                <div
                  className="overflow-hidden rounded-2xl border border-white/80 bg-card p-4 shadow-[0_0_20px_rgba(255,255,255,0.25),0_0_40px_rgba(255,255,255,0.1)] opacity-0 animate-[fade-in_0.5s_ease-out_forwards]"
                ...
                <div
                  className="overflow-hidden rounded-2xl border border-white/80 bg-white p-4 shadow-[0_0_20px_rgba(255,255,255,0.25),0_0_40px_rgba(255,255,255,0.1)] opacity-0 animate-[fade-in_0.5s_ease-out_forwards]"
              ...
              <div className="flex">
                <div
                  className="w-full overflow-hidden rounded-2xl border border-white/80 bg-card p-4 shadow-[0_0_20px_rgba(255,255,255,0.25),0_0_40px_rgba(255,255,255,0.1)] opacity-0 animate-[fade-in_0.5s_ease-out_forwards]"
